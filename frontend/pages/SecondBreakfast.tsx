...
const SecondBreakfast = () => {
    ...
    return(
        <FormContainer about={"Данные о втором завтраке"} down={'/breakfast'} next={'/Lunch'}>
            <Grid container>
                <Grid xs={12}>
                    <CheckBox/>
                </Grid>
                ...
                <Grid>
                    <Drink drinks={drinks} text={"Выберите напитки, которые Вы употребляли на второй завтрак?"}/>
                </Grid>
                <Grid xs={10}>
                    <TimeInput/>
                </Grid>
